...
public class ScienceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ScienceFragment.NewsAsyncTask newsAsyncTask = new ScienceFragment.NewsAsyncTask();
    ...
    public class NewsAsyncTask extends AsyncTask<Void , Void , List<News>>
    {
        ...
        protected List<News> doInBackground(Void... voids) {
            List<News> News = HelperFunctions.fetchNewsData("https://newsapi.org/v2/top-headlines?sources=new-scientist&apiKey=81d6974107fa425e9f86766cab89b964");
            return News ;
        }
