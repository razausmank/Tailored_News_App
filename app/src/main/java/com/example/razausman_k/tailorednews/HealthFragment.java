...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HealthFragment.NewsAsyncTask newsAsyncTask = new HealthFragment.NewsAsyncTask();
    ...
    public class NewsAsyncTask extends AsyncTask<Void , Void , List<News>>
    {
        ...
        protected List<News> doInBackground(Void... voids) {
            List<News> News = HelperFunctions.fetchNewsData("\n" +
                    "https://newsapi.org/v2/top-headlines?sources=medical-news-today&apiKey=81d6974107fa425e9f86766cab89b964");
            return News ;
        }
